      ...
      <div className="grid grid-cols-1 gap-16 lg:gap-4">
        ...
        <div className="grid grid-cols-1 gap-16 lg:gap-44">
          <PresentationBox
            ...
            description={
              <>
                I made this portfolio with my dad&apos;s help. The code is
                written in next.js and the programming language is typescript.
                Because of next.js I learned basics of react. It is styled with
                next ui and tailwind. And it is versioned in github.
              </>
            }
            gridItems={[
              <Image
          ...
          <PresentationBox
            ...
            description={
              <>
                ...
                enhance programming skills through fun and interactiv pojects.
                We had exciting activities such as working with robots, virtual
          ...
          <PresentationBox
            ...
            description={
              <>
                ...
                basics, web development, and 3D printing. We engaged with
                virtual technology and Lego robotics. We also took and edited
                some photograps we made.
              </>
            }
            gridItems={[
              <Image
          ...
          <PresentationBox
            ...
            description={
              <>
                ...
                School. We did things like digital photography, video
                production, podcast creation and a lot of editing. We also
                recorded a{" "}
                <Link
                  isExternal
          ...
          <PresentationBox
            ...
            description={
              <>
                I took this online Javascript course. It is designed to teach
                you Javascript in a fun and simple way. I learned there
                different fundimetals of Javascript. I created a lot of fun
                projects like interactive games and animations. I learned how to
                solve some simple problems and understand the core prinicipal of
                programming.
              </>
            }
            gridItems={[
